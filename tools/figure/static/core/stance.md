...
This skill uses a Python/Matplotlib single-track backend for formal data figures. Solver outputs from MATLAB or other languages must be exported to traceable files before plotting.
